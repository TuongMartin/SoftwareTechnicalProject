				...
				<div class="carousel-item">
					<div class="listing-item compact">
						...
						<a href="single-property-page-3.html" class="listing-img-container">
							...
							<img src="<%=request.getContextPath()%>/templates/public/images/listing-04.jpg" alt="">
						</a>
				...
				<div class="carousel-item">
					<div class="listing-item compact">
						...
						<a href="single-property-page-1.html" class="listing-img-container">
							...
							<img src="<%=request.getContextPath()%>/templates/public/images/listing-06.jpg" alt="">
						</a>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="testimonial-box">
					...
					<div class="testimonial-author">
						<img src="<%=request.getContextPath()%>/templates/public/images/happy-client-01.jpg" alt="">
			...
			<div class="col-md-4">
				<div class="testimonial-box">
					<div class="testimonial">Aliquam dictum elit vitae mauris facilisis, at dictum urna dignissim. Donec vel lectus vel felis lacinia luctus vitae iaculis arcu. Mauris mattis, massa eu porta ultricies.</div>
					<div class="testimonial-author">
						<img src="<%=request.getContextPath()%>/templates/public/images/happy-client-02.jpg" alt="">
			...
			<div class="col-md-4">
				<div class="testimonial-box">
					<div class="testimonial">Aliquam dictum elit vitae mauris facilisis, at dictum urna dignissim. Donec vel lectus vel felis lacinia luctus vitae iaculis arcu. Mauris mattis, massa eu porta ultricies.</div>
					<div class="testimonial-author">
						<img src="<%=request.getContextPath()%>/templates/public/images/happy-client-03.jpg" alt="">
...
<!-- Flip banner -->
<a href="listings-half-map-grid-standard.html" class="flip-banner parallax" data-background="<%=request.getContextPath()%>/templates/public/images/flip-banner-bg.jpg" data-color="#274abb" data-color-opacity="0.9" data-img-width="2500" data-img-height="1600">
