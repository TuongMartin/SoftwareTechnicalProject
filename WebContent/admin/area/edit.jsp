			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="card">
						...
						<div class="content">
						<%
							KhuVucBDS objKhuVucUpdate = (KhuVucBDS)request.getAttribute("objKhuVucUpdate");
						%>
							<form action="" method="post" id="editAreaRealEstate" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Tên khu vực</label> <input type="text" name="area"
												class="form-control border-input" placeholder="Tên khu vực"
												value="<%=objKhuVucUpdate.getTen() %>">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="text-center">
									...
									<a href="<%=request.getContextPath() %>/admin/area-real-estate" class="btn btn-success btn-fill btn-wd">Quay lại</a>
								</div>
				...
				<script type="text/javascript">
					$(document).ready(function() {
						$("#editAreaRealEstate").validate({
							...
							messages : {
								area : {
									required : "<span style='color:red'>Tên khu vực không được để trống!</span>",
